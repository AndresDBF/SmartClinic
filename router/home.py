...
routehome = APIRouter(tags=["userhome"], responses={status.HTTP_404_NOT_FOUND: {"message": "Direccion No encontrada"}})
...
routehome.mount("/img", StaticFiles(directory=img_directory), name="img")

def home(userid: int, request: Request):
