...
adminhome = APIRouter(tags=["Admin Home"], responses={status.HTTP_404_NOT_FOUND: {"message": "Direccion No encontrada"}})
...
adminhome.mount("/img", StaticFiles(directory=img_directory), name="img")

@adminhome.get("/admin/home/{userid}")
